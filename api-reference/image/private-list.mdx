---
title: "查询个人镜像"
api: "GET https://www.chenyu.team/api/open/v1/image/private/list"
...
url = "https://www.chenyu.team/api/open/v1/image/private/list"
headers = {
...
const url = 'https://www.chenyu.team/api/open/v1/image/private/list';
const headers = {
    'Authorization': 'Bearer your_api_key',
    'Content-Type': 'application/json'
};
...
```curl cURL
curl -X GET "https://www.chenyu.team/api/open/v1/image/private/list" \
