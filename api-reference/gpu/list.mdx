---
title: "获取平台GPU列表"
api: "GET https://www.chenyu.team/api/open/v1/gpu/list"
...
url = "https://www.chenyu.team/api/open/v1/gpu/list"
headers = {
...
const url = 'https://www.chenyu.team/api/open/v1/gpu/list';
const headers = {
    'Authorization': 'Bearer your_api_key'
};
...
```curl cURL
curl -X GET "https://www.chenyu.team/api/open/v1/gpu/list" \
