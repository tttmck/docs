---
title: "查询实例列表"
api: "GET https://www.chenyu.team/api/open/v1/instance/list"
...
url = "https://www.chenyu.team/api/open/v1/instance/list"
headers = {
...
const url = 'https://www.chenyu.team/api/open/v1/instance/list';
const headers = {
    'Authorization': 'Bearer your_api_key',
    'Content-Type': 'application/json'
};
...
```curl cURL
curl -X GET "https://www.chenyu.team/api/open/v1/instance/list?page=1&page_size=10" \
