---
title: "通过Pod创建实例"
api: "POST https://www.chenyu.team/api/open/v1/instance/create_by_pod"
...
<ParamField body="pod_tag" type="string" required>
  Pod版本标签
</ParamField>
...
url = "https://www.chenyu.team/api/open/v1/instance/create_by_pod"
headers = {
...
const url = 'https://www.chenyu.team/api/open/v1/instance/create_by_pod';
const headers = {
    'Authorization': 'Bearer your_api_key',
    'Content-Type': 'application/json'
};
...
```curl cURL
curl -X POST "https://www.chenyu.team/api/open/v1/instance/create_by_pod" \
