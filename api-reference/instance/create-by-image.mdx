---
title: "通过镜像创建实例"
api: "POST https://www.chenyu.team/api/open/v2/instance/create_by_image"
...
url = "https://www.chenyu.team/api/open/v2/instance/create_by_image"
headers = {
...
const url = 'https://www.chenyu.team/api/open/v2/instance/create_by_image';
const headers = {
    'Authorization': 'Bearer your_api_key',
    'Content-Type': 'application/json'
};
...
```curl cURL
curl -X POST "https://www.chenyu.team/api/open/v2/instance/create_by_image" \
...
```json
{
  ...
  "data": {
    ...
    "server_url": [
      "https://jupyter-inst456.chenyu.team",
      "https://ssh-inst456.chenyu.team"
    ],
    "save_image_status": 2,
    "charging_type": 1,
    "shutdown_regular": {
