---
title: "通过镜像创建实例"
api: "POST https://www.chenyu.team/api/open/v1/instance/create_by_image"
...
url = "https://www.chenyu.team/api/open/v1/instance/create_by_image"
headers = {
...
const url = 'https://www.chenyu.team/api/open/v1/instance/create_by_image';
const headers = {
    'Authorization': 'Bearer your_api_key',
    'Content-Type': 'application/json'
};
...
```curl cURL
curl -X POST "https://www.chenyu.team/api/open/v1/instance/create_by_image" \
