---
title: "设置定时关机"
api: "POST https://www.chenyu.team/api/open/v1/instance/shutdown-timer"
...
url = "https://www.chenyu.team/api/open/v1/instance/shutdown-timer"
headers = {
...
const url = 'https://www.chenyu.team/api/open/v1/instance/shutdown-timer';
const headers = {
    'Authorization': 'Bearer your_api_key',
    'Content-Type': 'application/json'
};
...
```curl cURL
curl -X POST "https://www.chenyu.team/api/open/v1/instance/shutdown-timer" \
