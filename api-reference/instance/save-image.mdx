---
title: "保存为镜像"
api: "POST https://www.chenyu.team/api/open/v1/instance/save-image"
...
url = "https://www.chenyu.team/api/open/v1/instance/save-image"
headers = {
...
const url = 'https://www.chenyu.team/api/open/v1/instance/save-image';
const headers = {
    'Authorization': 'Bearer your_api_key',
    'Content-Type': 'application/json'
};
...
```curl cURL
curl -X POST "https://www.chenyu.team/api/open/v1/instance/save-image" \
