...
<ParamField query="order_channel" type="integer" optional>
  扣费渠道
  1.余额消费
  2.算力卡消费
</ParamField>
...
params = {
    "page": "1",
    "page_size": "10",
    "order_channel": 1,  # 可选，1.余额消费 2.算力卡消费
...
```curl cURL
curl -X GET "https://www.chenyu.team/api/open/v1/bill/list?page=1&page_size=10&order_channel=1&order_number=ORD123456789" \
