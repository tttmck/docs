---
title: "查询应用市场Pod"
api: "GET https://www.chenyu.team/api/open/v1/pod/list"
...
url = "https://www.chenyu.team/api/open/v1/pod/list"
headers = {
...
const url = 'https://www.chenyu.team/api/open/v1/pod/list';
const headers = {
    'Authorization': 'Bearer your_api_key',
    'Content-Type': 'application/json'
};
...
```curl cURL
curl -X GET "https://www.chenyu.team/api/open/v1/pod/list?page=1&page_size=10&name=pytorch" \
